...
export const ElementaryLiteracySectionTitle = (
  <Text
    color="gray.800"
    fontWeight="600"
...
export const ElementaryLiteracySectionDescription = '문해력은 한 영역만 잘한다고 되는 게 아니에요.\n러니는 세 가지 영역을 하나의 루틴 안에서 균형있게 다뤄요.'

export const ElementaryLiteracySectionCateforyList: string[] = [
  "주요 기능 02",
  "기초학력 학습",
];

export const ElementaryLiteracySectionCards: LiteracyCard[] = [
  {
    title: "읽기 학습",
